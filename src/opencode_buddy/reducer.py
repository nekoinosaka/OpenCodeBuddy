...
class BuddySnapshot:
    ...
    def as_ble_payload(self) -> dict:
        ...
        if self.token20v1 is not None:
            payload["token20v1"] = str(self.token20v1)
...
class BuddyStateReducer:
    def __init__(self, *, tokens: int = 0, tokens_today: int = 0) -> None:
        ...
        self._msg = "No OpenCode connected"
        self._tokens = tokens
